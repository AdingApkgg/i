...
async function main() {
  await db.post.upsert({
    ...
    create: {
      ...
      title: "你好，世界 ✿",
      excerpt:
        "i 个人空间 v2 的第一篇文章。Next 全栈 · Prisma 7 · tRPC · better-auth · 粉粉的萌系设计。",
      contentMd:
  ...
  if ((await db.photo.count()) === 0) {
    const travel = await db.album.upsert({
      where: { name: "旅行记录" },
      update: {},
      create: { name: "旅行记录", coverUrl: "https://picsum.photos/seed/umi/800/800" },
    });
    await db.photo.createMany({
      data: [
        {
          title: "海边",
          imageUrl: "https://picsum.photos/seed/umi/800/800",
          takenAt: "2024-08",
          albumId: travel.id,
        },
        {
          title: "樱花",
          imageUrl: "https://picsum.photos/seed/sakura/800/800",
          takenAt: "2024-04",
          albumId: travel.id,
        },
        {
          title: "街道",
          imageUrl: "https://picsum.photos/seed/machi/800/800",
          takenAt: "2024-06",
          albumId: travel.id,
        },
      ],
